      ...
      <main className="max-w-7xl mx-auto p-5 sm:p-6 lg:p-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <Link href="/market-research" className="block p-4 sm:p-6 bg-gray-800 rounded-lg border border-gray-700 hover:bg-gray-700 hover:border-gray-500 transition-colors">
              <h3 className="text-lg sm:text-xl font-bold">Market Intelligence</h3>
              <p className="mt-2 text-gray-400 text-sm sm:text-base">Customer segments, strategy, and competitor analysis.</p>
            </Link>
          </div>
        </section>
      </main>
